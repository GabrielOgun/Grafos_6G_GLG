...
class TGrafoND{
  private:
    ...
    int *classes; //Vetor de classes de coloração
    int maxProduto;
  public:
    TGrafoND( int n);
    ...
    void show();
      ...
      bool isEuleriano();
      int podeColorir(int v, int c);
      void coloracaoPorClasse();
      float encontrarMaiorProduto(int origem, int destino);
      void dfs(int visitados[], int u, int destino, int produto);
